...
import com.chenxing.userservice.interceptor.CustomUserService;
import com.chenxing.userservice.interceptor.MyAuthenticationProvider;
...
public class MyAuthenticationConfig {
	...
	// @Override(如果是override，需要继承WebSecurityConfigurerAdapter接口)
